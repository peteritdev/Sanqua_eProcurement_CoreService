			...
			if (xResultList.data.length > 0) {
				...
				for (var index in xRows) {
					xJoArrData.push({
						...
						vendor: {
							id:
								xRows[index].vendor_id != null
									? await _utilInstance.encrypt(
											xRows[index].vendor_id.toString(),
											config.cryptoKey.hashKey
										)
									: null,
							clear_id: xRows[index].vendor_id,
							code: xRows[index].vendor_id != null ? xRows[index].vendor_code : '',
							name: xRows[index].vendor_id != null ? xRows[index].vendor_name : null
						},
						merk: xRows[index].merk,
						...
						photo: {
							photo_1:
								xRows[index].product_photo_1 != null && xRows[index].product_photo_1 != ''
									? config.frontParam.photoPath.product.product1 + xRows[index].product_photo_1
									: null,
							photo_2:
								xRows[index].product_photo_2 != null && xRows[index].product_photo_2 != ''
									? config.frontParam.photoPath.product.product2 + xRows[index].product_photo_2
									: null,
							photo_3:
								xRows[index].product_photo_3 != null && xRows[index].product_photo_3 != ''
									? config.frontParam.photoPath.product.product3 + xRows[index].product_photo_3
									: null,
							photo_4:
								xRows[index].product_photo_4 != null && xRows[index].product_photo_4 != ''
									? config.frontParam.photoPath.product.product4 + xRows[index].product_photo_4
									: null,
							photo_5:
								xRows[index].product_photo_5 != null && xRows[index].product_photo_5 != ''
									? config.frontParam.photoPath.product.product5 + xRows[index].product_photo_5
									: null
						},
						...
						last_price: xRows[index].last_price,
						last_ordered:
							xRows[index].last_ordered != null && xRows[index].last_ordered != ''
								? moment(xRows[index].last_ordered).format('YYYY-MM-DD')
								: '',
			...
			if (xResultList.count > 0) {
				...
				for (var index in xRows) {
					xJoArrData.push({
						...
						phone1:
							xRows[index].vendor.phone1 != ''
								? (await _utilInstance.decrypt(xRows[index].vendor.phone1, config.cryptoKey.hashKey))
										.decrypted
								: '',
						phone2:
							xRows[index].vendor.phone2 != ''
								? (await _utilInstance.decrypt(xRows[index].vendor.phone2, config.cryptoKey.hashKey))
										.decrypted
								: '',
						email:
							xRows[index].vendor.email != ''
								? (await _utilInstance.decrypt(xRows[index].vendor.email, config.cryptoKey.hashKey))
										.decrypted
								: '',
