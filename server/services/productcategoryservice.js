...
class ProductCategoryService {
    ...
    async list(param){
        ...
        var xResultList = await _productCategoryRepoInstance.list(param);
    ...
    async save(param){
        var joResult;
        var checkDuplicateResult = await _productCategoryRepoInstance.isDataExists(param.name);
        ...
        if( ( param.act == "add" && checkDuplicateResult == null ) || param.act == "update" ){
            ...
            if( flagProcess )joResult = await _productCategoryRepoInstance.save( param );
    ...
    async delete( param ){
        ...
        if( flagProcess )joResult = await _productCategoryRepoInstance.delete(param);
