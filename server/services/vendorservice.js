		...
		if (xResultList.count > 0) {
			...
			for (var index in xRows) {
				xJoArrData.push({
					...
					phone1:
						xRows[index].phone1 != null && xRows[index].phone1 != ''
							? (await _utilInstance.decrypt(xRows[index].phone1, config.cryptoKey.hashKey)).decrypted
							: '',
					phone2:
						xRows[index].phone2 != null && xRows[index].phone2 != ''
							? (await _utilInstance.decrypt(xRows[index].phone2, config.cryptoKey.hashKey)).decrypted
							: '',
					email:
						xRows[index].email != null && xRows[index].email != ''
							? (await _utilInstance.decrypt(xRows[index].email, config.cryptoKey.hashKey)).decrypted
							: '',
