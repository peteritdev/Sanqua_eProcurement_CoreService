...
class ProcurementQuotationItemRepository {
	...
	async addItemCopyFromProcurementItem(pParam) {
		...
		try {
			...
			xSql =
				' INSERT INTO tr_procurementquotationitems( procurement_vendor_id, product_id, unit_id, unit_price, currency_id, qty, total, created_at, created_by, created_by_name ) ' +
			...
			var xDtQuery = await sequelize.query(
				xSql,
				{
