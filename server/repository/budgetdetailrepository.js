...
// Model
const _modelDb = require('../models/index.js').tr_budgetdetails;
const _modelProductCategory = require('../models/index.js').ms_productcategories;
...
const _xClassName = 'BudgetDetailRepository';
...
class BudgetDetailRepository {
	...
	async list(pParam) {
		...
		try {
			...
			if (pParam.hasOwnProperty('budget_id')) {
