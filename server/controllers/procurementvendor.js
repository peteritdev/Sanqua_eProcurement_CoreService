...
module.exports = { procurementVendor_Save, procurementVendor_GetById, procurementVendor_List, procurementVendor_Delete, procurementVendor_Unarchive, procurementVendor_Archive, procurementVendor_VendorConfirm }
...
async function procurementVendor_VendorConfirm( req, res ){
    ...
    if( oAuthResult.status_code == "00" ){
        if( oAuthResult.token_data.status_code == "00" ){
            ...
            if( errors.length != 0 && req.body.act == "add" ){
                ...
                req.body.token = req.headers['x-token'];
                req.body.method = req.headers['x-method'];
                joResult = await _serviceInstance.vendorConfirm(req.body);
                joResult.token_data = oAuthResult.token_data;
                joResult = JSON.stringify(joResult);
            }
        }else{
