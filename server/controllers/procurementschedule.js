...
// Service
const ProcurementScheduleService = require('../services/procurementscheduleservice.js');
const _serviceInstance = new ProcurementScheduleService();

const { check, validationResult } = require('express-validator');

module.exports = { procurementSchedule_Save, procurementSchedule_GetById, procurementSchedule_List, procurementSchedule_Delete, procurementSchedule_Unarchive, procurementSchedule_Archive }

async function procurementSchedule_List( req, res ){
    var joResult;
...
async function procurementSchedule_Save( req, res ){
...
async function procurementSchedule_Archive( req, res ){
...
async function procurementSchedule_Unarchive( req, res ){
...
async function procurementSchedule_Delete( req, res ){
...
async function procurementSchedule_GetById( req, res ){
    var joResult;
    var oAuthResult = await _oAuthServiceInstance.verifyToken( req.headers['x-token'], req.headers['x-method'] );
