...
// Service
const ProcurementItemService = require('../services/procurementitemservice.js');
const _serviceInstance = new ProcurementItemService();

const { check, validationResult } = require('express-validator');

module.exports = { procurementItem_Save, procurementItem_GetById, procurementItem_List, procurementItem_Delete, procurementItem_Unarchive, procurementItem_Archive }

async function procurementItem_List( req, res ){
    var joResult;
...
async function procurementItem_Save( req, res ){
...
async function procurementItem_Archive( req, res ){
...
async function procurementItem_Unarchive( req, res ){
...
async function procurementItem_Delete( req, res ){
...
async function procurementItem_GetById( req, res ){
    var joResult;
    var oAuthResult = await _oAuthServiceInstance.verifyToken( req.headers['x-token'], req.headers['x-method'] );
