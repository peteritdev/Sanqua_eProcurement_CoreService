...
module.exports = (app) => {
	...
	// Product Category
	arrValidate = [];
	arrValidate = [ check('name').not().isEmpty().withMessage('Parameter name can not be empty') ];
	...
	arrValidate = [];
	app.get(
		rootAPIPath + 'master/product_category/drop_down',
		arrValidate,
		productCategoryController.productCategory_DropDown
	);
	...
	app.delete(rootAPIPath + 'master/product/delete/:id', xArrValidateProduct, productController.product_Delete);
	...
	arrValidate = [];
	app.post(
		rootAPIPath + 'master/business_entity/upload',
		arrValidate,
		masterController.businessEntity_UploadFromExcel
	);
	...
	arrValidate = [ check('name').not().isEmpty().withMessage('Parameter name cannot be empty') ];
	app.post(
		rootAPIPath + 'master/spesification_category/save',
		arrValidate,
		spesificationCategoryController.spesificationCategory_Save
	);
	...
	app.get(
		rootAPIPath + 'master/spesification_category/list',
		arrValidate,
		spesificationCategoryController.spesificationCategory_List
	);

	arrValidate = [];
	arrValidate = [ check('id').not().isEmpty().withMessage('Parameter id cannot be empty') ];
	app.get(
		rootAPIPath + 'master/spesification_category/detail/:id',
		arrValidate,
		spesificationCategoryController.spesificationCategory_GetById
	);

	arrValidate = [];
	app.get(
		rootAPIPath + 'master/spesification_category/drop_down',
		arrValidate,
		spesificationCategoryController.spesificationCategory_DropDown
	);
	...
	arrValidate = [ check('id').not().isEmpty().withMessage('Parameter id cannot be empty') ];
	app.delete(
		rootAPIPath + 'master/spesification_category/delete/:id',
		spesificationCategoryController.spesificationCategory_Delete
	);

	// Import
	arrValidate = [];
	app.post(
		rootAPIPath + 'master/spesification_category/upload',
		arrValidate,
		spesificationCategoryController.spesificationCategory_UploadFromExcel
	);
	app.post(
		rootAPIPath + 'master/spesification_category/batch_save',
		arrValidate,
		spesificationCategoryController.spesificationCategory_BatchSave
	);
	...
	arrValidate = [ check('name').not().isEmpty().withMessage('Parameter name cannot be empty') ];
	app.post(
		rootAPIPath + 'master/spesification_attribute/save',
		arrValidate,
		spesificationAttributeController.spesificationAttribute_Save
	);
	...
	app.get(
		rootAPIPath + 'master/spesification_attribute/list',
		arrValidate,
		spesificationAttributeController.spesificationAttribute_List
	);

	arrValidate = [];
	arrValidate = [ check('id').not().isEmpty().withMessage('Parameter id cannot be empty') ];
	app.get(
		rootAPIPath + 'master/spesification_attribute/detail/:id',
		arrValidate,
		spesificationAttributeController.spesificationAttribute_GetById
	);

	arrValidate = [];
	app.get(
		rootAPIPath + 'master/spesification_attribute/drop_down',
		arrValidate,
		spesificationAttributeController.spesificationAttribute_DropDown
	);
	...
	arrValidate = [ check('id').not().isEmpty().withMessage('Parameter id cannot be empty') ];
	app.delete(
		rootAPIPath + 'master/spesification_attribute/delete/:id',
		spesificationAttributeController.spesificationAttribute_Delete
	);

	// Import
	arrValidate = [];
	app.post(
		rootAPIPath + 'master/spesification_attribute/upload',
		arrValidate,
		spesificationAttributeController.spesificationAttribute_UploadFromExcel
	);
	app.post(
		rootAPIPath + 'master/spesification_attribute/batch_save',
		arrValidate,
		spesificationAttributeController.spesificationAttribute_BatchSave
	);
