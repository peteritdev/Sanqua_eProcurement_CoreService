...
module.exports = (app) => {
	...
	app.get(`${_rootAPIPath}rab_v2/export_to_pdf/:id`, exportController.generateRAB_V2);
	app.get(`${_rootAPIPath}fpb_v2/export_to_pdf/:id`, exportController.generateFPB_V2);
};
