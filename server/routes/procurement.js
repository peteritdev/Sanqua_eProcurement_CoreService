...
module.exports = (app) => {
	...
	arrValidate = [
		...
		check('status_approval', 'Parameter status_approval must be integer and can not be empty')
			.not()
			.isEmpty()
			.isInt()
	...
	arrValidate = [
		check('act').not().isEmpty().withMessage('Parameter act cannot be empty'),
		check('procurement_id').not().isEmpty().withMessage('Parameter procurement_id cannot be empty'),
		check('schedule_attribute_id', 'Parameter schedule_attribute_id must be integer and cannot be empty')
			.not()
			.isEmpty()
			.isInt(),
	...
	app.get(
		rootAPIPath + 'quotation_item/list',
		arrValidate,
		procurementQuotationItemController.procurementQuotationItem_List
	);
	...
	app.post(
		rootAPIPath + 'quotation_item/update',
		arrValidate,
		procurementQuotationItemController.procurementQuotationItem_Update
	);
	...
	arrValidate = [
		check('id').not().isEmpty().withMessage('Parameter id cannot be empty'),
		check('unit_price_negotiation', 'Parameter unit_price must be integer and cannot be empty')
			.not()
			.isEmpty()
			.isInt()
	];
	app.post(
		rootAPIPath + 'quotation_item/update_negotiation',
		arrValidate,
		procurementQuotationItemController.procurementQuotationItem_UpdateNegotiation
	);
	...
	arrValidate = [
		check('act').not().isEmpty().withMessage('Parameter act cannot be empty'),
		check('procurement_id').not().isEmpty().withMessage('Parameter procurement_id cannot be empty'),
		check('evaluation_attribute_id', 'Parameter evaluation_attribute_id must be integer and cannot be empty')
			.not()
			.isEmpty()
			.isInt(),
	...
	app.post(
		rootAPIPath + 'evaluation/save_evaluation',
		arrValidate,
		procurementEvaluationController.procurementEvaluation_SaveEvaluation
	);
